...
- Model picker rows now escape provider-supplied model names and IDs before rendering, and the providers panel escapes load-error text before inserting it into the DOM.
